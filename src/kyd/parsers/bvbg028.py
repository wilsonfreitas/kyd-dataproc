...
attrs = {
    ...
    'OptnOnEqtsInf': {
        ...
        'underlying_security_id': 'InstrmInf/OptnOnEqtsInf/UndrlygInstrmId'
                                  '/OthrId/Id',
        'underlying_security_proprietary': 'InstrmInf/OptnOnEqtsInf'
                                           '/UndrlygInstrmId/OthrId/Tp/Prtry',
        'underlying_security_market': 'InstrmInf/OptnOnEqtsInf/UndrlygInstrmId'
                                      '/OthrId/PlcOfListg/MktIdrCd',
        ...
        'automatic_exercise_indicator': 'InstrmInf/OptnOnEqtsInf'
                                        '/AutomtcExrcInd',
    },
    'FutrCtrctsInf': {
        ...
        'underlying_security_id': 'InstrmInf/FutrCtrctsInf/UndrlygInstrmId'
                                  '/OthrId/Id',
        'underlying_security_proprietary': 'InstrmInf/FutrCtrctsInf'
                                           '/UndrlygInstrmId/OthrId/Tp/Prtry',
        'underlying_security_market': 'InstrmInf/FutrCtrctsInf/UndrlygInstrmId'
                                      '/OthrId/PlcOfListg/MktIdrCd',
...
def get_bvbg028_instruments(text):
    ...
    exchange = root[0][0]
    xs = exchange.findall(
        '{urn:bvmf.052.01.xsd}BizGrp/{urn:bvmf.100.02.xsd}Document/'
        '{urn:bvmf.100.02.xsd}Instrm')
    for xx in xs:
